...
export function ProductForm({ product }: ProductFormProps) {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    formData.set("slug", slug || handleSlugify(name));
    ...
    <form onSubmit={handleSubmit} className="flex flex-col gap-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 flex flex-col gap-6">
            ...
            <div className="rounded-2xl border border-line bg-bg-elev/30 p-6 flex flex-col gap-5">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <Input
                  ...
                  defaultValue={product?.category ?? "Beauté & Soins"}
                />
              </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 pt-2 border-t border-line/60">
                <Input
                  ...
                  placeholder="15000"
                  defaultValue={product?.price ?? 15000}
                  required
                  min={0}
                />
                <Input
                  ...
                  placeholder="25000"
                  defaultValue={product?.compareAtPrice ?? 25000}
                  min={0}
          ...
          {activeTab === "media" && (
            <div className="rounded-2xl border border-line bg-bg-elev/30 p-6 flex flex-col gap-6">
              {/* Vidéos Reels UGC */}
              <div>
