...
async function main() {
  console.log("🚀 Début de l'insertion / mise à jour du Purificateur d'Eau pour Robinet 6 Couches OyaMarket™...");
  ...
  const dataFilePath = path.join(__dirname, "../data/products/filtre-eau-robinet-charbon.json");
