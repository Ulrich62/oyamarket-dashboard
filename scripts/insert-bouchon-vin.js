...
async function main() {
  console.log("🚀 Début de l'insertion / mise à jour du Bouchon Pompe à Vide d'Air pour Vin OyaMarket™...");
  ...
  const dataFilePath = path.join(__dirname, "../data/products/bouchon-vide-air-vin-dateur.json");
  ...
  for (const pack of product.packs) {
    ...
    console.log(`   📦 Pack inséré : ${pack.name} (${pack.price} FCFA)`);
  }

  console.log("✨ Insertion terminée avec succès pour le Bouchon Pompe à Vide d'Air pour Vin OyaMarket™ !");
}
